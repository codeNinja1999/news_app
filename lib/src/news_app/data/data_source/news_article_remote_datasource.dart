...
import 'package:news_app/core/config/news_category/news_category_url.dart';
import 'package:news_app/core/error/exception.dart';
import 'package:news_app/core/error/failure.dart';
import 'package:news_app/src/news_app/data/models/article_model.dart';
...
class NewsArticleRemoteDatasourceImpl implements NewsArticleRemoteDatasource {
  ...
  Future<List<Article?>> _getRandomArticleFromCategory() async {
    try {
      ...
      const String url =
          AppConfig.baseUrl + NewsCategoryUrl.appleUrl + AppConfig.apiKey;
